 ...
 * {@link ListasReproduccionFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link ListasReproduccionFragment#newInstance} factory method to
...
public class ListasReproduccionFragment extends Fragment {
    ...
    private NestedScrollView contenedorListas;
     ...
     * @return A new instance of fragment ListasReproduccionFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static ListasReproduccionFragment newInstance(String param1, String param2) {
        ListasReproduccionFragment fragment = new ListasReproduccionFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        contenedorListas = (NestedScrollView) view.findViewById(R.id.contenedor_listas);
        ...
        if (!listasRep.getListasReproduccion().isEmpty()) {
            for (String nombreLista : listasRep.getListasReproduccion().keySet()) {
                generateLinearLista(nombreLista);
            }
        }
    ...
    private void generateLinearLista(String nombreLista) {
        ...
        contenedorListas.addView(linearLayout);
    }
